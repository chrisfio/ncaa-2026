...
import type { TrackerData } from '@/lib/espn'
            ...
            <table className="w-full text-sm">
                      ...
                      <td className="px-3 py-2.5 sm:px-4 sm:py-3">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            {team.lastGame && (
                              <p className="text-xs text-gray-500 mt-0.5 sm:hidden leading-snug">{team.lastGame}</p>
                            )}
                          </div>
                        </div>
                      </td>
              ...
              <tfoot>
                <tr className="bg-gray-900 border-t border-gray-700 font-semibold text-sm">
                  ...
                  <td className="px-3 py-2.5 sm:px-4 sm:py-3 text-right text-gray-300 hidden sm:table-cell">
                    {fmt(TOTAL_TEAM_SPEND)}
                  </td>
                  <td className="px-3 py-2.5 sm:px-4 sm:py-3 text-right">
                    {teams.reduce((s, t) => s + t.wins, 0)}
                  </td>
                  <td className="px-3 py-2.5 sm:px-4 sm:py-3 text-right text-green-400 hidden sm:table-cell">
                    {fmt(totalPayout)}
                  </td>
                  <td className="px-3 py-2.5 sm:px-4 sm:py-3 text-right">
                    {mode === 'mine'
                      ? <NetBadge value={userNet} />
                      : <NetBadge value={totalTeamNet} />
                    }
                  </td>
